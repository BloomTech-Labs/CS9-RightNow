...
export const Container = glamorous.div({ // backgroundColor: "#fff",
         // color: "black",
         //padding: "70px",
         padding: "40px", margin: "7%", border: "3px solid white", color: "#353A50", backgroundColor: "#f7f9fc", //boxShadow: "0 10px 6px -6px #777",
